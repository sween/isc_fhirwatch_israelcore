...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      <sch:assert test="count(f:extension[@url = 'path']) &gt;= 1">extension with URL = 'path': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'path']) &lt;= 1">extension with URL = 'path': maximum cardinality of 'extension' is 1</sch:assert>
      ...
      <sch:assert test="count(f:extension[@url = 'forDisplay']) &lt;= 1">extension with URL = 'forDisplay': maximum cardinality of 'extension' is 1</sch:assert>
